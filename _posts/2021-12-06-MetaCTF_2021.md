...
Similar to MetaCTF, I felt that with persistence many of the challenges could be solved without necessarily having a great deal of background knowledge. The challenges seem usually laid out in a way that enough clues are provided, you just need a little research to supplement.
